...
def create_account():
    ...
    user_pw = input("Whats your password? ")
    random_account["user_name"] = user_name
    random_account["user_password"] = user_pw
    random_account["balance"] = float(0)
...
deposit_money(random_account, 34)
...
withdrawl(random_account, 10)
withdrawl(random_account, 25)
