...
artist_popularity = result['artists']['items'][0]['popularity']
artist_followers = result['artists']['items'][0]['followers']['total']

artist_info = (f"Beyonces popularity ranking is: {artist_popularity}, and she has {artist_followers} followers")  # fill this in
...
chosen_artists = ["Bad Bunny", "Drake", "J Balvin", "Marshmello", "The Weekend"]
...
for artist in chosen_artists:
    ...
    chosen_artists = {"Artist Name" : artist,
                       "Id": artist_id,
                       "popularity": artist_popularity,
                       "followers": artist_followers}
                     
    popularities.append(chosen_artists)
...
most_pop = popularities[0]["Artist Name"]
least_pop = popularities[3]["Artist Name"]

print(f"The most popular artist of my group is {most_pop}, the least popular is {least_pop}. ")


""" Most_follower = popularities[0]["followers"]
Least_popular = popularities[3]["Artist Name"]
Least_follower = popularities[3]["followers"]

print(f"The most popular artist is {Most_popular} with {Most_follower} followers. The least popular artist is {Least_popular} with {Least_follower} followers.")
...
# wow this is really cool, I found this code that finds related artists based on just my input of which artist I wanted. Check out below. 

#code to get related artist by inputting name of artist 
import sys
...
#Found code to get related artist by id

x = popularities[4]["Id"]

print(x)
y = sp.artist_related_artists(x)

jprint(y)


sim = sp.artist_related_artists(x) # fill this in
...
print("Artist = The Weekend, popularity 98, the next three similiar artists doesn't have the same popularity")