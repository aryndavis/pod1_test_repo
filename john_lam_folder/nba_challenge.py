...
print(f"In the 2020 NBA playoffs, James Harden made {james_harden_3pts_made} 3 point shots, and {james_3pt_attempts} shots attempts")
print(f"In the 2020 NBA playoffs, Fred Vanleet made {fred_vanvleet_3pts_made} 3 point shots, and {fred_3pt_attempts} shots attempts")
print(f"In the 2020 NBA playoffs, Jamal Murry {jamal_murray_3pts_made} 3 point shots, and {jamal_3pt_attempts} shots attempts")
...
print(f"lakers are the best NBA team {lakers_are_best}")
