...
# 'artist' (string)
# 'title' (string)
song1 = {'artist': 'The Weeknd', 'title': 'Losers'}
song2 = {'artist': 'Nipsey Hussle', 'title': 'Victory Lap'}
song3 = {'artist': 'JayZ', 'title': "U don't know"}
...
print('Question 5')
print()
song4 = {'artist': 'Tupac', 'title': 'Changes'}
song5 = {'artist': 'Michael Jackson', 'title': 'Thriller'}

add_song(my_playlist, song4)
add_song(my_playlist, song5)
display_playlist(my_playlist)
...
print('BONUS')
# Went through this with Paul.. it's his code, but I understand the concepts.
