...
print("it is a list because of square brackets")
...
print('This is a list of dictionaries, hard brackets determine the list, and nested within are curved brackets (dictionaries) ')
...
def search_by_author(author):
    title_author = [] 
    for names in books_with_details:
        if author == names['author']:
            title_author.append(names['title'])
