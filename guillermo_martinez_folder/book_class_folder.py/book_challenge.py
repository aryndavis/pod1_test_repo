...
nyt_bestsellers.add('This is not a T-Shirt', 'Bobby Hundreds')
nyt_bestsellers.add('Made up Title1', 'Guillermo Martinez')
nyt_bestsellers.add('2nd Made up Title', 'Bob')
print(nyt_bestsellers.book_list)
