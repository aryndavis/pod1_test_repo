...
fav_restaurants['Chicken_spot'] = "180 Brooklyn Ave, Brooklyn, NY 11221: centerbreasts: 24 hours"
print(fav_restaurants)
print()
fav_restaurants['Pizzeria'] = "180 Queens Ave, Queens, NY 10201: Reg slice: 10am - 9pm"
print()
print(fav_restaurants)
print()
fav_restaurants['Halal'] = "180 Bronx Ave, Bronx, NY 10056: Gyro: 12pm - 10pm"
print(fav_restaurants)
...
fav_restaurants['Halal']
print()
fav_restaurants['Halal'] = "180 Bronx Ave, Bronx, NY 10056: Gyro: 12pm - 7pm"
print(fav_restaurants['Halal'])
