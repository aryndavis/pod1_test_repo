...
user_acct = {}
def create_account():
    user_acct['Username'] = input("Choose a username: ")
    user_acct['Password'] = input("Choose a password: ")
    user_acct['Balance']= float(0)
    print(user_acct)
...
def deposit(user_acct, amount):
    amount = float(input("How much would you like to deposit?: "))
    user_acct['Balance'] = user_acct['Balance'] + amount
    print(user_acct)
    

deposit(user_acct, 'amount')
...
def withdraw(user_acct, amount):
    amount = float(input("How much would you like to withdraw? ")) 
    if amount <= user_acct['Balance']:
        user_acct['Balance'] = user_acct['Balance'] - amount
        print(user_acct)
    else: 
        print("You have insufficient funds")

withdraw(user_acct, 'amount')
...
def withdraw_secure(user_acct, password, amount):
    password = input("What is your password? ")
    if password == user_acct['Password']:
        amount = float(input("How much would you like to withdraw? ")) 
        if amount <= user_acct['Balance']:
            user_acct['Balance'] = user_acct['Balance'] - amount
            print(user_acct)
...
withdraw_secure(user_acct, 'password', 'amount')

def deposit_secure(user_acct, password, amount):
    password = input("What is your password? ")
    if password == user_acct['Password']:
        amount = float(input("How much would you like to deposit?: "))
        user_acct['Balance'] = user_acct['Balance'] + amount
...
deposit_secure(user_acct, 'password', 'amount')

# Worked with Shawn Greene to complete this.