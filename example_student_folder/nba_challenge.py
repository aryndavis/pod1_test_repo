...
print(f"In the 2020 NBA playoffs, Jamal Murray made {jamal_murray_3pts_made} 3 point shots and {jamal_murray_3pts_attempt} shot attempts.")

# TODO: Create print statement here for Fred VanVleet
print(f"In the 2020 NBA playoffs, Fred VanVleet made {vanvleet_3pts_made} 3 point shots and {vanvleet_3pts_attempt} shot attempts.")

# TODO: Create print statement here for James Harden
print(f"In the 2020 NBA playoffs, James Harden made {harden_3pts_made} 3 point shots and {harden_3pts_attempt} shot attempts.")
...
print(f"Jamal Murray's 3 pt percentage is {jamal_murray_3pts_made/jamal_murray_3pts_attempt}")
# OR
j_m_percentage = jamal_murray_3pts_made / jamal_murray_3pts_attempt
print(f"Jamal Murray's 3 pt percentage is {j_m_percentage}")

# TODO: Calculate and print the 3 point percentage for Fred VanVleet
print(f"Fred VanVleet's 3 pt percentage is {vanvleet_3pts_made/vanvleet_3pts_attempt}")

# TODO: Calculate and print the 3 point percentage for James Harden
print(f"James Harden's 3 pt percentage is {harden_3pts_made/harden_3pts_attempt}")
print()
...
print(f"I think that the idea that the Lakers are the best NBA team is {lakers_are_best}.")
...
j_m_percentage = jamal_murray_3pts_made / jamal_murray_3pts_attempt
vanvleet_percentage = vanvleet_3pts_made / vanvleet_3pts_attempt
harden_percentage = harden_3pts_made / harden_3pts_attempt
