...
#Books is a list because it uses brackets. Also:
print(type(books))
...
print("books_with_details is a list because it has hard brackets. The individual items are dictionaries because they have curly brackets.")
# 2.1
