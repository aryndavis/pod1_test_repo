...
#creating variable to call in the function
my_song = {'artist': 'The Beatles',
            'title': 'Yellow Submarine'}

#using the function to add the song to my_playlist
...
print('Question 5')
my_song2 = {'artist': 'Ani DiFranco',
            'title': 'Little Plastic Castles'}
my_song3 = {'artist': 'The Doors',
