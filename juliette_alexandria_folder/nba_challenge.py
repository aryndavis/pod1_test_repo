...
print(f"In the 2020 NBA playoffs, Fred VanVleet {fred_vanvleet_3pts_made} 3 point shots")
...
print(f"In the 2020 NBA playoffs, Jamal Murray made {jamal_murray_3pts_made} 3 point shots and {jamal_murray_3pt_attempts} shot attempts.")

print(f"In the 2020 NBA playoffs, Fred VanVleet made {fred_vanvleet_3pts_made} 3 point shots and {fred_vanvleet_3pt_attempts} shot attempts.")

print(f"In the 2020 NBA playoffs, James Harden made {james_harden_3pts_made} 3 point shots and {james_harden_3pt_attempts} shot attempts.")
print()
...
jamal_murray_3pt_percent = (jamal_murray_3pts_made)/(jamal_murray_3pt_attempts)
print(f"Jamal Murray's 3 point percentage is {jamal_murray_3pt_percent}")

# TODO: Calculate and print the 3 point percentage for Fred VanVleet
fred_vanvleet_3pt_percent = (fred_vanvleet_3pts_made)/(fred_vanvleet_3pt_attempts)
print(f"Fred VanVleet's 3 point percentage is {fred_vanvleet_3pt_percent}")

# TODO: Calculate and print the 3 point percentage for James Harden
james_harden_3pt_percent = (james_harden_3pts_made)/(james_harden_3pt_attempts)
print(f"James Harden's 3 point percentage is {james_harden_3pt_percent}")
...
fred_vanvleet_3pt_percent = (fred_vanvleet_3pts_made)/(fred_vanvleet_3pt_attempts)
print(str(fred_vanvleet_3pt_percent))
james_harden_3pt_percent = (james_harden_3pts_made)/(james_harden_3pt_attempts)
print(str(james_harden_3pt_percent))
print()
