...
#The time complexity for the previous function is 0(n)
...
# TODO Write the time complexity
#The time complexity for the previous function is 0(n^2)
...
''' 
#This function takes each item in the list and compares that item to the next index item. Returns True if they match, false if not
my_list = [5,2,3,4,5,8]
