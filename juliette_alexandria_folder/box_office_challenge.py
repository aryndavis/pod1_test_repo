...
#Splitting "movies_str" into a list based on the "," character
...
#removing "The Matrix" from "remaning_50_list"
...
# Adding "Anywhere But Here" and then printing "remaining_50_list"
...
#using len to check how many items are in the list
print (f"There are {len(remaining_50_list)} items in the 'Remaining 50' list.")
...
#Using index item 0 to print the first item in the list
print(top_100[0])
...
# Note: Print your new variable to see the string version of the movie
