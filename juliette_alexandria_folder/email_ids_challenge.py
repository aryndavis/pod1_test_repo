...
for name in names:
    lower_employee = name.lower()
    employee_names_list = (lower_employee.split(" "))
    joined_employees = (".".join(employee_names_list))
    emails.append(joined_employees + "@ripplemedia.com")
