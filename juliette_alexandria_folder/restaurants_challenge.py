...
print(f'The address for the restaurant is {restaurant["address1"]} {restaurant["city"]} {restaurant["state"]} {restaurant["zip_code"]}')
...
fav_restaurants = {"burrito_boy": ["123 Franklin Blvd, Eugene, Oregon 97403" , "Enchiladas" , "10am-11pm"],
                   "papa_murphy": ["763 W. 11th Ave, Eugene, Oregon 97405", "Chicago Stuffed Pizza", "10am-10pm"],
                    "taco_time": ["344 A street, Springfield, Oregon 97477", "Stuffed Mexi Fries", "9am-12pm"]}
...
fav_restaurants.pop("burrito_boy")
print(fav_restaurants)
print()
...
print(f"Taco Time's old open hours were {fav_restaurants['taco_time'][2]}.")
fav_restaurants["taco_time"][2] = "11am-9pm"
print(f"Taco Time's new open hours are {fav_restaurants['taco_time'][2]}.")
