...
result = (sp.search(name, limit=10, offset=0, type='artist', market=None))
...
artist_info =  result['artists']['items'][0]['popularity']
...
chosen_artists = ['Prince', 'Beyonce', 'The Beatles', 'The Doors', 'Madonna']
popularities = []
artist_info2 = {}


for i in chosen_artists:
    artist_info2 = {}
    results = sp.search(i, limit=10, offset=0, type='artist', market=None)
    artist_info2['artist_name'] =  results['artists']['items'][0]['name']
    artist_info2['artist_id'] =  results['artists']['items'][0]['id']
    artist_info2['popularity'] =  results['artists']['items'][0]['popularity']
    artist_info2['total_followers'] = results['artists']['items'][0]['followers']['total']
    popularities.append(artist_info2)
...
print(popularities)
print(popularities[1]['artist_name'], popularities[0]['artist_name'])
