...
fav_restaurants["Wendys"] = ["5805 Broadway, Bronx, NY 10463", "Spicy Nuggets", "7AM-3AM"]
fav_restaurants["Little Caesars"] = ["119 W Kingsbridge Rd, Bronx, NY 10468", "Hawaiin Pizza", "11AM-3AM"]
fav_restaurants["El Mangu Restaurant"] = ["80 W Kingsbridge Rd, Bronx, NY 10468", "Churrasco Con Tostones", "7AM-10PM"] 
...
old_hours = fav_restaurants["Little Caesars"][2] 
fav_restaurants["Little Caesars"][2] = "10AM-11PM"
new_hours = fav_restaurants["Little Caesars"][2]

# TODO: Print the old and new open hours of the restaurant by accessing those fields from the dictionary.
print(f'The old hours of Little Caesars were {old_hours} and new hours are {new_hours}')
