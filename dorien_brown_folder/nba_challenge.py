...
vanvleet_3pt_attempts = 110
harden_3pt_attempts = 109
...
print(f"In the 2020 NBA playoffs, Fred Vanvleet made {vanvleet_3pts_made} 3 point shots and {vanvleet_3pt_attempts} shot attempts.")
print(f"In the 2020 NBA playoffs, James Harden made {harden_3pts_made} 3 point shots and {harden_3pt_attempts} shot attempts.")
...
print()
print(f"Jamal Murray's 3 pt percentage is{jamal_murray_3pts_made / jamal_murray_3pt_attempts}")
print(f"Fred Vanvleet's 3 pt percentage is{vanvleet_3pts_made / vanvleet_3pt_attempts}")
print(f"James Harden's 3 pt percentage is{harden_3pts_made / harden_3pt_attempts}")
...
print(f"Everyone knows the Lakers are the best they have the King{lakers_are_best}")
...
jamal_murray_percentage = jamal_murray_3pts_made / jamal_murray_3pt_attempts
vanvleet_percentage = vanvleet_3pts_made / vanvleet_3pt_attempts
harden_percentage = harden_3pts_made / harden_3pt_attempts
print("String Conversions:")
print(str (jamal_murray_percentage))
print(str (vanvleet_percentage))
print(str (harden_percentage))
print("Integers Conversions:")
