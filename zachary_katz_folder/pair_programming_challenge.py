...
def withdraw(account, amount):
    if amount <= account["balance"]:
        ...
        print(f'Not enough money to withdraw that amount! Only ${account["balance"]} available')

# test enough money to withdraw
withdraw(my_account, 1.25)
print(my_account)

# test not enough money to withdraw
withdraw(my_account, 6.75)
print(my_account)
...
deposit_secure(my_account, 15.50)
print(my_account)
withdraw_secure(my_account, 3.50)
print(my_account)