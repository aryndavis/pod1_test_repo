...
print(f'URL for Apple Macbook Pro is {laptops[0]["url"]}')
# TODO: Write code to print all possible prices of the 16-inch MacBook Pro.
print(f'Possible prices of the 16-inch MacBook Pro are {laptops[0]["types"][1]["price"]}')
# TODO: Write code to print all the color options for Dell XPS 13.
print(f'Colors for Dell XPS 13 inch include {laptops[1]["types"][0]["colors"]}')
